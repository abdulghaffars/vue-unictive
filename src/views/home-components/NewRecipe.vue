...
<template>
  <div>
    ...
    <div
      class="flex flex-col sm:flex-row gap-4 sm:gap-8 lg:gap-16 justify-center items-center"
    >
      <div class="w-[40%]">
        <img :src="newRecipe?.image" alt="New Recipe" class="rounded-lg" />
      </div>
      <div
        class="w-[60%] flex flex-col gap1 sm:gap-4 justify-center items-center sm:items-start"
      >
        <h1
